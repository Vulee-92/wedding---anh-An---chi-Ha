...
export default function WeddingInvitation() {
        ...
        >
          ...
          <p 
                            style={{
                                ...
                                fontFamily:
                                    'ui-serif, Georgia, Cambria, "Times New Roman", Times, serif', // Serif font for the title
                            }}
                        >
        ...
        <div className="w-full h-screen relative">
          ...
          <div className="relative w-full h-screen bg-white overflow-hidden">
            ...
            <div className="w-full h-full relative">
                            ...
                            <img
                                src={
                                    weddingImages.mainPhoto ||
                                    "/placeholder.svg"
                                }
                                alt="Ảnh cưới chính - Mobile"
                                className="w-full h-full object-cover animate-ken-burns block md:hidden"
                                loading="eager"
                            />
                            {/* Desktop image */}
                            <img
                                src="https://res.cloudinary.com/da4wi5yxi/image/upload/v1753783390/IMG_5419_xvuoze.jpg"
                                alt="Ảnh cưới chính - Desktop"
                                className="w-full h-full object-cover animate-ken-burns hidden md:block"
                loading="eager"
              />
 ...
 {/* Section 0: Main Wedding Photo Layout */}
            <section
                className="h-screen flex items-center justify-center relative bg-gradient-to-br from-gray-50 via-white to-gray-100 overflow-hidden"
                data-animate
                id="section-0"
            >
        {/* Background Pattern */}
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-6 sm:px-8 text-center">
          {/* Bible Verse - Top */}
            ...
            <p
                                className="text-md sm:text-lg text-gray-600 italic leading-relaxed font-light"
                                style={{
                                    fontFamily: "Playfair Display, serif",
                                }}
                            >
                                "Nếu Đức Chúa Trời yêu thương chúng ta như thế,
                                chúng cũng phải yêu thương nhau."
                            </p>
                            <p
                                className="text-sm text-gray-500 font-light mt-2"
                                style={{
                                    fontFamily: "Playfair Display, serif",
                                }}
                            >
          ...
          {/* Main Title */}
            ...
            {/* Cross with Flying Birds */}
                        <div
                            className={`flex items-center justify-center space-x-6 sm:space-x-8 my-8 transition-all duration-1000 ${
                                isElementVisible("section-0")
              ...
              <div className="relative">
                ...
                <div className="absolute -top-3 -left-2 animate-float-slow">
                                ...
                                <div
                                    className="absolute -top-2 -right-1 animate-float-slow"
                                ...
                                <div
                                    className="absolute -bottom-2 -left-1 animate-float-slow"
                                ...
                                <div
                                    className="absolute -bottom-1 -right-2 animate-float-slow"
                ...
                <div className="absolute -top-1 -right-2">
                  <div className="w-3 sm:w-4 h-3 sm:h-4 border border-accent rounded-full animate-pulse"></div>
                                    <div
                                        className="w-2.5 sm:w-3 h-2.5 sm:h-3 border border-accent rounded-full absolute top-0.5 left-1.5 sm:left-2 animate-pulse"
                                        style={{ animationDelay: "0.5s" }}
                                    ></div>
                </div>
              </div>
          ...
          {/* Wedding Date */}
          <div
                        className={`text-2xl sm:text-3xl text-gray-600 font-light tracking-[0.1em] transition-all duration-1000 ${
                            isElementVisible("section-1")
                                ? "animate-slide-up opacity-100"
                                : "opacity-0 translate-y-8"
                }`}
                        style={{
        ...
        <div className="absolute top-20 left-10 opacity-10 animate-float-slow">
          <div className="w-2 h-2 bg-accent rounded-full"></div>
                ...
                <div
                    className="absolute top-32 right-16 opacity-10 animate-float-slow"
                    style={{ animationDelay: "1s" }}
                >
          <div className="w-1 h-1 bg-accent rounded-full"></div>
        </div>
                <div
                    className="absolute bottom-32 left-20 opacity-10 animate-float-slow"
                    style={{ animationDelay: "2s" }}
                >
          <div className="w-1.5 h-1.5 bg-accent rounded-full"></div>
        </div>
                <div
                    className="absolute bottom-40 right-24 opacity-10 animate-float-slow"
                    style={{ animationDelay: "1.5s" }}
                >
          <div className="w-1 h-1 bg-accent rounded-full"></div>
        </div>
      ...
      <section className="h-screen flex items-center justify-center relative bg-white overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
          <div
                        className={`text-center opacity-[0.08] transition-all duration-2000 ${
                            currentSection >= 2 ? "animate-ocean-wave" : ""
              }`}
          >
            <div
            ...
            >
              25
                ...
                <div
                    className="text-center space-y-8 sm:space-y-12 z-10 px-4"
                    data-animate
                    id="section-2"
                >
                    <h1
                        className={`text-6xl sm:text-8xl text-primary font-normal transition-all duration-1000 ${
                            isElementVisible("section-2")
          ...
          >
            Ân
                    ...
                    <p
                        className={`text-8xl sm:text-8xl text-primary mb-4 font-ooohbaby transition-all duration-1000 ${
                            isElementVisible("section-2")
      ...
      <section className="min-h-screen flex items-center justify-center bg-gray-50 py-3 sm:py-16">
                ...
                >
                    <div
                        className={`text-center space-y-8 bg-white border border-gray-300 rounded-lg py-8 px-4 sm:p-10 shadow-sm transition-all duration-1000 ${
                            isElementVisible("section-3")
                                ? "animate-slide-up opacity-100"
                                : "opacity-0 translate-y-8"
              }`}
          >
            ...
            <div className="grid grid-cols-2 gap-8 mb-10">
              <div className="text-center">
                                <h4
                                    className="text-sm font-bold text-gray-700 mb-4 uppercase tracking-wide"
                                    style={{
                                        fontFamily: "Playfair Display, serif",
                                    }}
                                >
            ...
            <div className="mb-10">
                            <p
                                className="text-sm font-bold text-gray-700 mb-3 uppercase tracking-wide"
                                style={{
                                    fontFamily: "Playfair Display, serif",
                                }}
                            >
            ...
            {/* Couple Names */}
            <div className="mb-10">
                            <h3 className="text-3xl sm:text-3xl text-primary font-light font-ooohbaby mb-3 leading-tight">
                John Ân
              </h3>
                            <p
                                className="text-xs text-gray-500 mb-4 flex items-center justify-center space-x-2"
                                style={{
                                    fontFamily: "Playfair Display, serif",
                                }}
                            >
                ...
                />
                            ...
                            <h3 className="text-3xl sm:text-3xl text-primary font-light font-ooohbaby leading-tight">
                Cát Hạ
              </h3>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div>
                  ...
                  ABC
                                ...
                                >
                                    (793/57/16 Trần Xuân Soạn, Phường Tân Hưng,
                                    Quận 7)
                </p>
              </div>
            </div>
      ...
      <section className="min-h-screen flex items-center justify-center bg-white py-8 sm:py-16">
                <div
                    className="w-full max-w-sm mx-auto text-center px-4"
                    data-animate
                    id="section-4"
                >
                    <div
                        className={`space-y-4 sm:space-y-6 mb-8 sm:mb-12 transition-all duration-1000 ${
                            isElementVisible("section-4")
                                ? "animate-slide-up opacity-100"
                                : "opacity-0 translate-y-8"
              }`}
          >
            ...
            >
              Album Ảnh Cưới
                        ...
                        <p
                            className="text-sm text-gray-600 tracking-widest font-light"
                            style={{ fontFamily: "Playfair Display, serif" }}
                        >
          ...
          <div className="space-y-4 sm:space-y-6">
            {/* Three Photos Layout */}
            <div
                            className={`grid grid-cols-3 gap-2 transition-all duration-1000 ${
                                isElementVisible("section-4")
                                    ? "animate-stagger-up opacity-100"
                                    : "opacity-0 translate-y-8"
                }`}
              style={{ animationDelay: "0.2s" }}
            >
            ...
            >
              ...
              >
                                <div
                                    className="flex items-center space-x-2 font-ephesis"
                                    style={{
                                        fontFamily: "Playfair Display, serif",
                                    }}
                                >
      ...
      <section className="min-h-screen flex items-center justify-center bg-gray-50 py-8 sm:py-16">
          ...
          <div className="space-y-6 sm:space-y-10">
            ...
            {/* Calendar Header */}
            <div
                            className={`flex items-end space-x-2 justify-center transition-all duration-1000 ${
                                isElementVisible("section-5")
                                    ? "animate-scale-in opacity-100"
                                    : "opacity-0 scale-90"
                }`}
            ...
            {/* Calendar Grid */}
            <div
                            className={`border border-gray-200 rounded-lg overflow-hidden bg-white shadow-sm transition-all duration-1000 ${
                                isElementVisible("section-5")
                                    ? "animate-slide-up opacity-100"
                                    : "opacity-0 translate-y-8"
                }`}
            ...
            >
              ...
              <div className="grid grid-cols-7">
                                {[
                                    ...
                                    <div
                                        key={day}
                                        className="p-2 text-xs font-medium text-white text-center bg-primary"
                                    >
                    {day}
                  </div>
                ))}
              ...
              <div className="grid grid-cols-7">
                ...
                {Array.from({ length: 30 }, (_, i) => {
                  ...
                  return (
                    <div
                      key={date}
                                            className={`p-3 sm:p-4 text-center border border-gray-100 relative transition-all duration-300 hover:bg-accent-light ${
                                                isWeddingDay
                                                    ? "bg-accent-light"
                                                    : ""
                                            }`}
                                        >
                                            <span
                                                className={` font-ooohbaby text-sm ${
                                                    isWeddingDay
            ...
            {/* Decorative Footer */}
            <div
                            className={`relative h-8 mt-6 sm:mt-8 flex items-center justify-center transition-all duration-1000 ${
                                isElementVisible("section-5")
                                    ? "animate-slide-up opacity-100"
                                    : "opacity-0 translate-y-8"
                }`}
      ...
      <section className="min-h-screen flex items-center justify-center bg-white py-8 sm:py-16">
          ...
          >
            <div className="relative">
              ...
              <p
                            ...
                            >
                                Sự hiện diện của bạn sẽ làm cho ngày đặc biệt
                                của chúng tôi trở nên hoàn hảo hơn
              </p>
            </div>
          </div>
        ...
        <div
          ...
          {/* Additional Info */}
          <div
                        className={`text-center mt-6 sm:mt-8 transition-all duration-1000 ${
                            isElementVisible("section-6")
                                ? "animate-slide-up opacity-100"
                                : "opacity-0 translate-y-8"
              }`}
      ...
      <section className="min-h-screen flex items-center justify-center bg-gray-50 py-8 sm:py-16">
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="text-center">
                  ...
                  >
                    NHÀ HÀNG SUNNY FARM
                                    ...
                                    >
                                        173/1 Bình Lợi, Phường 13, Quận Bình
                                        Thạnh
                                    </p>
                                    <p
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4">
                  <Button
                                        onClick={() =>
                                            window.open(
                                                "https://www.google.com/maps/dir//173%2F1+B%C3%ACnh+L%E1%BB%A3i%2C+Ph%C6%B0%E1%BB%9Dng+13%2C+B%C3%ACnh+Th%E1%BA%A1nh%2C+Th%C3%A0nh+ph%E1%BB%91+H%E1%BB%93+Ch%C3%AD+Minh",
                                                "_blank"
                                            )
                                        }
                    variant="outline"
                ...
                <div className="bg-gray-50 rounded-2xl p-4 sm:p-6 space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                                        ...
                                        <span
                                            className="text-primary text-sm:text-base"
                                            style={{
                                                fontFamily:
                                                    "Playfair Display, serif",
                                            }}
          ...
          >
              ...
              <br />
                            Vui lòng đến đúng giờ để không bỏ lỡ những khoảnh
                            khắc đặc biệt
            </p>
          </div>
        </div>
      ...
      <section className="min-h-screen flex items-center justify-center bg-white py-8 sm:py-16">
                <div
                    className="w-full max-w-lg mx-auto space-y-8 sm:space-y-12 px-4"
                    data-animate
                    id="section-8"
                >
          {/* <div className="text-center">
          ...
          <div className="text-center">
            ...
            <div className="space-y-4 sm:space-y-6">
              <p
                                className={`font-manrope text-gray-600 mb-6 sm:mb-8 leading-relaxed text-sm font-light transition-all duration-1000 ${
                                    isElementVisible("section-8")
                                        ? "animate-slide-up opacity-100"
                                        : "opacity-0 translate-y-8"
                  }`}
              ...
              >
                                Nếu bạn muốn gửi một món quà nhỏ để chúc mừng
                                hạnh phúc của chúng tôi, bạn có thể chuyển khoản
                                qua thông tin sau:
              </p>
              ...
              {bankingInfo.map((bank, index) => (
                <Card
                  key={index}
                                    className={`bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden transition-all duration-1000 ${
                                        isElementVisible("section-8")
                                            ? "animate-stagger-up opacity-100"
                                            : "opacity-0 translate-y-8"
                    }`}
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="bg-gray-50 rounded-xl p-3 space-y-2">
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <div className="flex items-center space-x-2">
                                                            <span
                                                                className="text-sm text-primary font-mono font-medium"
                                                                style={{
                                                                    fontFamily:
                                                                        "Playfair Display, serif",
                                                                }}
                            ...
                            <div className="text-center">
                                                            <div
                                                                className="text-xs text-accent font-medium animate-fade-in-up"
                                                                style={{
                                                                    fontFamily:
                                                                        "Playfair Display, serif",
                                                                }}
              ...
              <p
                                className={`text-gray-500 mt-4 sm:mt-6 italic text-sm font-light transition-all duration-1000 ${
                                    isElementVisible("section-8")
                                        ? "animate-slide-up opacity-100"
                                        : "opacity-0 translate-y-8"
                  }`}
              ...
              >
                                Đây là tùy chọn, sự hiện diện của bạn là món quà
                                quý giá nhất!
              </p>
            </div>
          </div>
      ...
      {/* Photo Gallery Component */}
            <PhotoGallery
                ...
                photos={weddingImages.albumPhotos}
            />
